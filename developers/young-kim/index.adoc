...
* link:https://nsalexamy.github.io/service-foundry/pages/documents/[Technical Articles on GitHub] +
...
* **Observability Frameworks**: OpenTelemetry(OpenTelemetry Collector, OpenTelemetry Instrumentation, OpenTelemetry Target Allocator), OpenTelemetry Protocol(OTLP),  OpenTelemetry Operator
...
* *Logs and Traces Analysis*: Apache Spark, Apache Airflow, Neo4j, Cassandra, OpenSearch, DuckDB, Sling
...
. **Big Data Engineering on Kubernetes** - Designed and implemented a scalable data engineering platform for healthcare analytics.

...
[source,yaml]
----
include::cert-manager/clusterissuer-selfsigned-bootstrap.yaml[]
----
...
[source,yaml]
----
include::cert-manager/nsa2-root-ca.yaml[]
----
...
[source,yaml]
----
include::cert-manager/clusterissuer-nsa2-ca.yaml[]
----
...
[source,yaml]
----
include::service-foundry/wildcard-nsa2-com.yaml[]
----

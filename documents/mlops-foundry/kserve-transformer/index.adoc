...
YouTube Video: https://youtu.be/BU_U6fB2404
...
[source,shell]
----
$ SERVICE_HOSTNAME="iris-classifier-kserve.servicefoundry.org" # <1>
...
* https://kserve.github.io/website/docs/model-serving/predictive-inference/transformers/custom-transformer[KServe Documentation — Custom Transformer]
* https://kserve.github.io/website/docs/reference/api/#serving.kserve.io/v1beta1.TransformerSpec[KServe API Reference — TransformerSpec]

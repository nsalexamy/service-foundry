...
image::service-foundry-console.png[Service Foundry Console Access]
...
.Console Dashboard
[.img-wide]
image::console-dashboard.png[Dashboard Overview]
...
.Storage Classes
[.img-wide]
image::console-storage-classes.png[Storage Classes]
...
.Console - Storage Classes Enabled
[.img-wide]
image::console-storage-classes-enabled.png[]
...
.Add EBS Storage Class
[.img-wide]
image::console-storage-classes-add-ebs.png[Add EBS Storage Class]
...
.Add EFS Storage Class
[.img-wide]
image::console-storage-classes-add-efs.png[Add EFS Storage Class]
...
.Add S3 Storage Class
[.img-wide]
image::console-storage-classes-add-s3.png[Add S3 Storage Class]
...
.Console - Persistent Volumes
[.img-wide]
image::console-persistent-volumes.png[Persistent Volumes]
...
[.img-wide]
image::console-persistent-volumes-view.png[View Persistent Volume Details]
...
.Console - Add EBS Persistent Volume
[.img-wide]
image::console-persistent-volumes-add-ebs.png[Add Persistent Volume]
...
.Console - Add EFS Persistent Volume
[.img-wide]
image::console-persistent-volumes-add-efs.png[Add Persistent Volume]
...
.Console - Add S3 Persistent Volume
[.img-wide]
image::console-persistent-volumes-add-s3.png[Add Persistent Volume]
...
.Console - Persistent Volume Claims
[.img-wide]
image::console-pv-claims.png[Persistent Volume Claims]
...
.Console - View Persistent Volume Claim
[.img-wide]
image::console-pv-claims-view.png[View Persistent Volume Claim]
...
.Console - Add EBS Persistent Volume Claim
[.img-wide]
image::console-pv-claims-add-ebs.png[Add Persistent Volume Claim]
...
.Console - Add EFS Persistent Volume Claim
[.img-wide]
image::console-pv-claims-add-efs.png[Add Persistent Volume Claim]
...
.Console - Add S3 Persistent Volume Claim
[.img-wide]
image::console-pv-claims-add-s3.png[Add Persistent Volume Claim]

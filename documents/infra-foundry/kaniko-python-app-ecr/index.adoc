        ...
        - |
          ...
          aws ecr get-login-password --region ca-west-1 \
            | docker login --username AWS \
                          --password-stdin 445567090745.dkr.ecr.ca-west-1.amazonaws.com && \
  ...
  containers:
    - name: kaniko
      ...
      args: ["--dockerfile=/workspace/Dockerfile",
             ...
             "--destination=445567090745.dkr.ecr.ca-west-1.amazonaws.com/kaniko-python-app"] # replace with your dockerhub account
...
$ kubectl -n kaniko run -it --rm kaniko-python-app \
  --image=445567090745.dkr.ecr.ca-west-1.amazonaws.com/kaniko-python-app \
  --restart=Never

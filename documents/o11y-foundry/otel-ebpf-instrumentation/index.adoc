...
* https://youtu.be/vVZWfBTeY7g[Mastering Observability with Service Foundry OBI: Zero-Code Instrumentation in Kubernetes]
* https://youtu.be/dNt0kZ0w_t0[Applying OBI to Go Applications — Zero‑Code Tracing with eBPF]
* https://youtu.be/4Gr3XMwWxf8[End-to-End Observability for Go Apps with OTel eBPF Instrumentation (OBI)]

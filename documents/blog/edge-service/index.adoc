---
layout: documents
title: Hostname based Gateway API Service using Traefik, ALB, and Route 53
summary: "Gateway API is the future of Kubernetes networking. In my latest article (and video), I break down how to build a scalable Edge Service using Traefik, AWS ALB, and Route 53. We dive deep into the differences between Traefik's native `IngressRoute` and the new Kubernetes standard `HTTPRoute`, showing you how to empower your backend engineers with self-service routing while keeping your platform secure."
tags: "#Kubernetes #Traefik #GatewayAPI #AWS #DevOps #CloudNative #SRE #PlatformEngineering"
...
YouTube Tutorial:: https://youtu.be/qjaFVdAZ1xk

📘 Web version:: https://nsalexamy.github.io/service-foundry/pages/documents/blog/edge-service/

---
layout: documents
title: Cross-Namespace Middleware Reference with Traefik for IngressRoute and HTTPRoute
summary: "Are you copy-pasting Traefik middleware across 10 different namespaces? Stop! 
...
tags: "#Kubernetes #Traefik #GatewayAPI #DevOps #SRE #PlatformEngineering #CloudNative"
...
YouTube Tutorial:: https://youtu.be/r3zaaSM7KAE

📘 Web version:: https://nsalexamy.github.io/service-foundry/pages/documents/blog/traefik-cross-namespace/
